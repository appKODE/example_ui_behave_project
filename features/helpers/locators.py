...
ARRIVAL_TIME = (By.ID, '%s:id/arrivalTime')
DEPARTURE_TIME = (By.ID, '%s:id/departureTime')
SEG_ARRIVAL_TIME = (By.ID, '%s:id/segmentArrivalTime')
SEG_DEPARTURE_TIME = (By.ID, '%s:id/segmentDepartureTime')
SEG_AIRPORTS_INFO = (By.ID, '%s:id/segmentAirportsInfo')
FLIGHT_PRICE = (By.ID, '%s:id/price')
FLIGHT_AIRPORTS = (By.ID, '%s:id/airportsInfo')
DURATION = (By.ID, '%s:id/duration')
VEHICLE = (By.ID, '%s:id/vehicleName')
LAYOVER_TIME = (By.ID, '%s:id/layoverInfo')

# группа локаторов выбора тарифов
TARIFF_TOOLBAR = (By.ID, '%s:id/toolbar')
TARIFF_STEP = (By.CLASS_NAME, 'android.widget.TextView')
TARIFF_BACKGROUND = (By.ID, '%s:id/tariffBackgroundFakeView')
TOTAL_PRICE_DESC = (By.ID, '%s:id/totalPriceDescription')
TOTAL_PRICE_VIEW = (By.ID, '%s:id/totalPriceView')
TARIFF_EXPANDER = (By.ID, '%s:id/expandArrowView')
TARIFF_SERVICE_TITLE = (By.ID, '%s:id/serviceTitle')
TARIFF_SERVICE_VALUE = (By.ID, '%s:id/serviceValue')
TARIFF_PRICE = (By.ID, '%s:id/tariffPrice')
TARIFF_TITLE = (By.ID, '%s:id/tariffTitle')
TARIFF_SUBTITLE = (By.ID, '%s:id/tariffSubtitle')
TARIFF_COMBINE_MESSAGE = (By.ID, 'android:id/message')
